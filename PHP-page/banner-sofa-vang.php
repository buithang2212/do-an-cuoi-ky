					<div class="banner2">
						<div class="cat-header">
							<h2>
								...
								<a href="category-product.php?cat=2">Ghế sofa văng</a>
							</h2>
						</div>
						<div class="contact-online">
							<div class="col-md-3">
								<div class="row">	
									...
									$sql_cat = "Select * from product where cat_id=2 order by add_date DESC limit 5";
							...
							<div class="col-md-9" style="padding-right: 0px;">
								<div class="col-md-12">
									<div class="row">
										<div>
											<div class="index-img">
												<a href="category-product.php?cat=2"><img src="../img/amu-sofa-banner.jpg" alt=""></a>
											</div>
											<div class="index-products">
												<?php 	


													$sql_cat = "Select * from product where cat_id=2 order by add_date DESC limit 3";
													$res_cat = mysqli_query($conn,$sql_cat);
												?>
												<?php if ($res_cat){ while ($row_cat1 = mysqli_fetch_assoc($res_cat)) { 
													$goc=$row_cat1['price'];
												...
												<div class="product hvr-float-shadow">
													<div>
														<div class="pro-img hvr-pulse-shrink">
